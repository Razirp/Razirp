<h1 align="center">Hi 👋, Here is Razirp!</h1>
<h3 align="center">🥸😊😲Dedicated to doing something interesting!🎉</h3>

📖 中文版点[这里](README.md)！

<p align="left"> <img src="https://komarev.com/ghpvc/?username=razirp&label=Profile%20views&color=0e75b6&style=flat" alt="razirp" /> </p>

- 🔗 Personal homepage: https://Razirp.github.io/en/ (Under construction)

- 📧 Email: razirp77@outlook.com
...
- 🚀 Trying to learn developing some basic components with C++

    - e.g: [A thread pool implementation based on modern C++](https://github.com/Razirp/ThreadPool) 😺

- 🔎 Have conducted research on object detection tasks in computer vision

- ⌨️ Programming languages used:
    
    - [![C](https://img.shields.io/badge/C-%2300599C.svg?style=flat-square&logo=C&logoColor=white)](https://en.wikipedia.org/wiki/C_(programming_language)) [![C++](https://img.shields.io/badge/C%2B%2B-%2300599C.svg?style=flat-square&logo=C%2B%2B&logoColor=white)](https://isocpp.org/) [![Java](https://img.shields.io/badge/Java-%23ED8B00.svg?style=flat-square&logo=Java&logoColor=white)](https://www.java.com/) [![Python](https://img.shields.io/badge/Python-%233776AB.svg?style=flat-square&logo=Python&logoColor=white)](https://www.python.org/) [![C#](https://img.shields.io/badge/C%23-%23239120.svg?style=flat-square&logo=C-Sharp&logoColor=white)](https://docs.microsoft.com/en-us/dotnet/csharp/) [![Verilog](https://img.shields.io/badge/Verilog-%23DDB700.svg?style=flat-square&logo=Verilog&logoColor=white)](https://en.wikipedia.org/wiki/Verilog) [![SQL](https://img.shields.io/badge/SQL-%23CC2927.svg?style=flat-square&logo=MySQL&logoColor=white)](https://en.wikipedia.org/wiki/SQL) [![MASM](https://img.shields.io/badge/MASM-0033A0?style=flat-square&logo=Microsoft&logoColor=white)](https://docs.microsoft.com/en-us/cpp/assembler/masm/microsoft-macro-assembler-reference)

    - I have no particular bias towards programming languages 🥸. Thanks to my experiences during my learning process, I can quickly learn and use new programming languages 🤓. I will try to use the most suitable language for the current task 🫡.

- 🛠️ Tools/Frameworks used:

    - [![Git](https://img.shields.io/badge/Git-%23F05033.svg?style=flat-square&logo=Git&logoColor=white)](https://git-scm.com/) [![GitHub](https://img.shields.io/badge/GitHub-%23181717.svg?style=flat-square&logo=GitHub&logoColor=white)](https://github.com/) [![OpenCV](https://img.shields.io/badge/OpenCV-%23white.svg?style=flat-square&logo=OpenCV&logoColor=white)](https://opencv.org/) [![PyTorch](https://img.shields.io/badge/PyTorch-%23EE4C2C.svg?style=flat-square&logo=PyTorch&logoColor=white)](https://pytorch.org/) [![NumPy](https://img.shields.io/badge/NumPy-%23013243.svg?style=flat-square&logo=NumPy&logoColor=white)](https://numpy.org/) [![Pandas](https://img.shields.io/badge/Pandas-%23150458.svg?style=flat-square&logo=Pandas&logoColor=white)](https://pandas.pydata.org/) [![scikit-learn](https://img.shields.io/badge/scikit--learn-%23F7931E.svg?style=flat-square&logo=scikit-learn&logoColor=white)](https://scikit-learn.org/) [![Detectron2](https://img.shields.io/badge/Detectron2-%234B8BBE.svg?style=flat-square&logo=Facebook&logoColor=white)](https://detectron2.readthedocs.io/)

    - Tools and frameworks are always used to better complete tasks 🧐. As long as there is a need, I am always open to learning and using new tools/frameworks 🤗.
...
- <details><summary>✨ Hobbies: </summary>
    ...
    - 🎮 Gaming: I enjoy playing some role-playing games with rich plots (naming ["Detroit: Become Human"](https://store.steampowered.com/app/1222140/Detroit_Become_Human/), ["Grand Theft Auto"](https://store.steampowered.com/app/271590/Grand_Theft_Auto_V/) series, ["Cyberpunk 2077"](https://store.steampowered.com/app/1091500/Cyberpunk_2077/) and ["Red Dead Redemption 2"](https://store.steampowered.com/app/1174180/Red_Dead_Redemption_2/)😎). Of course,  there's also["League of Legends"](https://www.leagueoflegends.com/en-us/) which accompanied me in killing time 😂.

    - 🎬 Movies and TV: I like watching some sci-fi/thought-provoking/mindless fun movies/TV shows, purely depending on my mood at the time 🥸.

    - 📖 Reading: Spending an afternoon reading in a bookstore on a day off is quite a delightful thing in the city, if you occasionally get tired of intense work 👀.
...
- 🌱 (Potentially) Upcoming Content:
    ...
    - Development of some new components

        - Perhaps there will be a TCP/IP protocol stack, memory pool, etc.
