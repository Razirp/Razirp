...
<h3 align="center">🥸😊😲致力于做一些有意思的事🎉</h3>
...
- 🔭 教育经历：
    ...
    - 北京理工大学计算机学院软件工程专业，硕士（2023~2025（预计））👨‍💻
    
    - 北京理工大学计算机学院计算机科学与技术专业，本科（2019~2023）👨‍🎓

- 🚀 正在尝试学习通过 C++ 语言进行一些基础组件的开发

    - 如：[一个基于现代 C++ 的线程池实现](https://github.com/Razirp/ThreadPool) 😺

- 🔎 曾经进行过关于计算机视觉目标检测任务相关的研究
...
- ⌨️ 使用过的编程语言：
    ...
    - 我对编程语言没有特别的偏向🥸。得益于我在学习过程中的经历，我能够快速地学习并使用新的编程语言🤓。我会尝试使用最适合当前任务的编程语言🫡。
...
- 🛠️ 使用过的工具/框架：
    ...
    - 工具和框架总是为了更好地完成任务🧐；只要存在需求，我对学习和使用新的工具/框架总是持开放态度🤗。
...
- 🤖 喜爱使用的 AI 工具：
    ...
    - 与 AI 工具的协同工作能够大大提高生产力和工作效率，并使我做到一些原本难以做到的事情（比如为我的项目提供中英双语的文档，感谢它们😘）。

- 🙋‍♂️ 我目前正在寻找 C/C++ 开发相关的实习，如果有相关机会可以提供，欢迎[联系我](razirp77@outlook.com) 😲

- <details><summary>🌍 关于语言（书面语言🥸）：</summary>

    - 在过去的学习工作过程中，我深感社区内缺乏足够的中文技术文档可供研究学习；一些项目即使是由中国开发者开发的，它们的文档仍然是英文🥲。这一现象使得庞大的中文开发者群体常常需要被迫使用英文等非母语语言进行学习和研究，不能够达到最佳的工作效率。~~那一刻我在想，如果我能成为一名职业开发者，我一定要（用中文）写下所有（致敬[ShowMaker](https://lol.fandom.com/wiki/ShowMaker)😉）~~ 因此我一直有一个愿望，即作为一名开发者，通过我的工作为中文开发者社区贡献更多有意义的内容。（考虑到母语为中文的开发者是一个庞大的群体，我认为这一想法还是蛮有意义的🤓）

    - 同时，我也深刻认同英文对于全球开发者之间进行交流和合作的重要性🥸👍；因此，在我的 GitHub 项目以及个人博客中，我会尽可能地提供中英双语的文档内容，以便使我所属的中文开发者群体和全球开发者群体都能够尽可能方便地获取到我所提供的信息🎉。</details>
...
- <details><summary>✨ 爱好：</summary>我喜欢一切新鲜的事物和有趣的事情，我认为不断探索新的可能性是人生中最能令人感到兴奋的部分。
    ...
    - 📱 数码产品：先进技术催生的各种千奇百怪的产品很有趣，这也是我从业的最初动力之一😏</details>
...
- 🌱 （可能）即将到来的内容：
    ...
    - 一些新的组件的开发
        ...
        - 我想借此精进技术、巩固知识的同时也为社区带来一定的贡献

    - 在BITCS学习阶段开发的一些项目（Coming soon!）

        - 希望能为初学者（尤其是来自BITCS的😉）的学习带来一定的帮助
