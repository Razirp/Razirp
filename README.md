...
- 🔭 教育经历：
    ...
    - 北京理工大学计算机学院软件工程专业，硕士在读（2023~2025（预计））👨‍💻
...
- 🙋‍♂️ 我目前正在寻找 C/C++ 开发相关的实习，如果有相关机会可以提供，欢迎联系我 (razirp77@outlook.com) 😲
...
- <details><summary>✨ 爱好：</summary>
    ...
    - 当然，有新的可能性就会有旧的可能性🤪，比如说：
        ...
        - 📖 阅读：休息日的下午在书店里看书是（城市里）极为惬意的事情，如果你偶尔厌倦紧张的工作的话👀
...
- 🌱 （可能）即将到来的内容：
    ...
    - 一些解决我需求的小工具
        ...
        - 比如调用大语言模型 API 实现自动中英文文档互译等（构思中🥸）
